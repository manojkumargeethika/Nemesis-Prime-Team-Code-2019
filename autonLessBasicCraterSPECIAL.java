...
@Autonomous(name="Auton less basic crater SPECIAL", group="Minibot")
public class autonLessBasicCraterSPECIAL extends LinearOpMode {
   // DigitalChannel digitalTouch;  // Hardware Device Object
    ...
    public void runOpMode() {
        ...
        sleep(1500);
        encoderDrive(DRIVE_SPEED,  -1023.4, -1023.4, 10);
