...
@Autonomous(name="Auton less basic BLU", group="Minibot")
public class autonLessBasicBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED, 1506, 1506, 60);// driving to depot
        markerServo.setPosition(1); // servo moves the marker
        sleep(1500); // gives time for servo to do its thing
        elevatorDrive (1, -10, 8);// coming off the lander
        encoderDrive(DRIVE_SPEED, -700, -700, 7);
        gyroTurn(TURN_SPEED, 135); // turn to crater
        encoderDrive(DRIVE_SPEED,2100,2100, 60);// drive toward crater
        telemetry.addLine("Nick Walls dab dab dab dab dab");
        telemetry.update();
    }
