...
@Autonomous(name="Auton less basic crater run", group="Minibot")
public class autonLessBasicCraterRun extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        elevatorDrive (1, -10, 8);// coming off the lander
        encoderDrive(DRIVE_SPEED, 1066.8, 1066.8, 60);// driving to crater
