...
@Autonomous(name="Auton Full Depot Red", group="Minibot")
public class autonFull2 extends LinearOpMode {
...
*/
        ...
        markerServo.setPosition(1); //claiming depo
        sleep(1500);
        encoderDrive(DRIVE_SPEED, -100, -100, 100);
        sleep(500);
        gyroTurnTo(TURN_SPEED, 325);
        encoderDrive(DRIVE_SPEED, 2100, 2100, 5.0); //driving to crater
    }
    ...
    public void encoderDrive(double speed,
        ...
        if (opModeIsActive()) {
            ...
            newLeftTarget = leftDrive.getCurrentPosition() - (int) (leftMM * COUNTS_PER_MM * 1);
            newRightTarget = rightDrive.getCurrentPosition() - (int) (rightMM * COUNTS_PER_MM * 1);
