                ...
                if (updatedRecognitions != null) {
                    ...
                    for (Recognition recognition : updatedRecognitions) {
                        if (recognition.getLabel().equals(LABEL_GOLD_MINERAL)) {
                            ...
                            encoderDrive(DRIVE_SPEED,350,350,10);
                            markerServo.setPosition(1);
                            sleep(1500);
                            encoderDrive (DRIVE_SPEED,-200,-200,20);
                            tFodDone = true;
                        }
                    }
                    if (tFodDone == false) {
                        gyroTurnTo(TURN_SPEED, 135);
                        sleep(500);
                        updatedRecognitions = tfod.getUpdatedRecognitions();
                        if (updatedRecognitions != null) {
                            telemetry.addData("# Object Detected", updatedRecognitions.size());
                            ...
                            for (Recognition recognition : updatedRecognitions) {
                                if (recognition.getLabel().equals(LABEL_GOLD_MINERAL)) {
                                    ...
                                    markerServo.setPosition(1);
                                    sleep(1500);
                                    encoderDrive (DRIVE_SPEED,-200,-200,10);
                                    sleep(500);
                                    tFodDone = true;
                                }
                            }
                    ...
                    if (tFodDone == false) {
                        ...
                        encoderDrive (DRIVE_SPEED, 650, 650, 5);
                        markerServo.setPosition(1);
                        sleep (1500);
                        encoderDrive(DRIVE_SPEED, -650, -650, 5);
                    }
