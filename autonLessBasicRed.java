...
@Autonomous(name="Auton less basic red", group="Minibot")
public class autonLessBasicRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        gyroTurnTo(TURN_SPEED, 315);// turning towards the
        encoderDrive(DRIVE_SPEED,2203.2, 2203.2, 10);
        elevatorDrive (1, -10, 8);// coming off the lander
        // gyroTurnTo(1, 45);// turning towards the
